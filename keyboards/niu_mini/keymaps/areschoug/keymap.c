...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-------+-------+-------+-------+-------+---------------+-------+-------+-------+-------+-------|
     * | Ctrl  |  Opt  | _NUM  |  CMD  | Lower |     Space     | Raise |   /   |  Left |  Down |  _FN  |
     * `-----------------------------------------------------------------------------------------------'
     */
    [_BASE] = LAYOUT_planck_mit(
        ...
        KC_LCTL, KC_LALT, MO(_NUM), KC_LCMD, LT(_LOWER, KC_BSPC), CMD_T(KC_SPC), LT(_RAISE, KC_ENT), KC_SLSH, KC_LEFT, MO(_ADJ), MO(_FN)
    ),
